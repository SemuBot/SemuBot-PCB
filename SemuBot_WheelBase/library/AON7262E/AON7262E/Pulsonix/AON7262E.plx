...
//10834981/1257230/2.50/11/3/MOSFET N-Channel
...
(library Library_1
	...
	(patternDef "AON7262E" (originalName "AON7262E")
		(multiLayer
			...
			(pad (padNum 9) (padStyleRef r245_198) (pt 0.000, 0.360) (rotation 90))
			(pad (padNum 10) (padStyleRef r43_38) (pt 1.415, 0.000) (rotation 0))
		...
		(layerContents (layerNumRef 18)
			(arc (pt -0.975, -2.15) (radius 0.05) (startAngle 270) (sweepAngle 180.0) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt -0.975 -2.1) (pt -0.975 -2.1) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(arc (pt -0.975, -2.15) (radius 0.05) (startAngle 90.0) (sweepAngle 180.0) (width 0.1))
		)
	)
	(symbolDef "AON7262E" (originalName "AON7262E")
	...
	(compDef "AON7262E" (originalName "AON7262E") (compHeader (numPins 11) (numParts 1) (refDesPrefix Q)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "AON7262E"))
		(attachedPattern (patternNum 1) (patternName "AON7262E")
			(numPads 11)
			(padPinMap
		...
		(attr "Manufacturer_Part_Number" "AON7262E")
		(attr "Description" "N-Channel 60 V 21A (Ta), 34A (Tc) 5W (Ta), 43W (Tc) Surface Mount 8-DFN-EP (3x3)")
		(attr "<Hyperlink>" "https://www.aosmd.com/sites/default/files/res/datasheets/AON7262E.pdf")
		(attr "<Component Height>" "0.9")
		(attr "<STEP Filename>" "AON7262E.stp")
